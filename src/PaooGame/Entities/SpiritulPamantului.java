...
/*! \class SpiritulPamantului
    \brief Clasa reprezinta o entitate de tip Spirit al Pamantului.

    Acest spirit este o entitate care nu ataca (asemanator unui NPC). Trebuie sa fie salvata
    pentru a duce jocul la bun sfarsit.
 */
public class SpiritulPamantului extends Character {
    ...
    /*! \fn public SpiritulPamantului(Game game, float x, float y, String m)
        \brief Constructorul clasei SpiritulPamantului.

        Initializeaza pozitia spiritului pe harta si asociaza mesajul de instructiuni primit ca parametru.
     */
    public SpiritulPamantului(Game game, float x, float y, String m) {
    ...
    /*! \fn public void Draw(Graphics g)
        ...
        Alterneaza cele doua imagini (`pamant1` si `pamant2`) la un interval de 30 de frame-uri.
    ...
    public void Draw(Graphics g) {
        if (contor < 30) {
            g.drawImage(Assets.pamant1, (int) x, (int) y, width, height, null);
        } else {
            g.drawImage(Assets.pamant2, (int) x, (int) y, width, height, null);
        }
    }
    ...
    /*! \fn public int getLife()
        \brief Returneaza viata spiritului. Valoarea este intotdeauna 0.
