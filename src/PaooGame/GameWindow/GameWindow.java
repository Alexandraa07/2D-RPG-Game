...
public class GameWindow
{
    ...
    public void BuildGameWindow()
    {
        ...
        wndFrame.pack(); ///Ajusteaza dimensiunea ferestrei in functie de continut
        wndFrame.setLocationRelativeTo(null); ///Centreaza fereastra pe ecran
        wndFrame.setVisible(true);  ///Face fereastra vizibila
    ...
    //Returneaza referinta catre fereastra principala a jocului
