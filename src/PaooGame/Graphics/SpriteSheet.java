...
public class SpriteSheet
{
    ...
    /*! \fn public BufferedImage crop2(int x, int y, int width, int height)
        \brief Returneaza o subimagine de dimensiune personalizata.

        Spre deosebire de metoda crop(), aceasta metoda permite
        specificarea dimensiunilor subimaginii.(pentru alte dimensiuni de entitati)

        \param x Coordonata dalei pe axa X.
        \param y Coordonata dalei pe axa Y.
        \param width Latimea subimaginii.
        \param height Inaltimea subimaginii.

        \return Obiect BufferedImage ce contine subimaginea selectata.
     */
