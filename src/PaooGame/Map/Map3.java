...
/*! \class Map3
    \brief Reprezinta harta 3 a jocului, compusa din mai multe straturi (layere).
 ...
 */
public class Map3 extends BaseMap {
    ...
    /*! \fn public Map3()
        \brief Constructorul clasei Map3.

        Incarca toate layerele hartii din fisierele CSV corespunzatoare.
     */
    public Map3() {

        water = new MapLayer("/maps/Harta3_water.csv", 120, 80);
        grass = new MapLayer("/maps/Harta3_grass.csv", 120, 80);
        road  = new MapLayer("/maps/Harta3_drum.csv", 120, 80);

        /// Layer-ul utilizat pentru coliziuni.
        collision = new MapLayer("/maps/Harta3_Collision.csv", 120, 80);

        /// Layere desenate peste jucator.
        leaf1 = new MapLayer("/maps/Harta3_OverPlayer1.csv", 120, 80);
        leaf2 = new MapLayer("/maps/Harta3_OverPlayer2.csv", 120, 80);
        leaf3 = new MapLayer("/maps/Harta3_OverPlayer3.csv", 120, 80);
    }
